...
import (
	...
	"github.com/nkien0204/lets-go/internal/infrastructure/network/http_handler/responses"
...
func SignIn(db *gorm.DB) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		if result := db.Table(models.UsersTable).Where("username = ?", creds.Username).First(&userModel); result.Error != nil {
